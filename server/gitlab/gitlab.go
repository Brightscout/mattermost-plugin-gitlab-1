...
type Gitlab interface {
	...
	CreateIssue(ctx context.Context, user *UserInfo, issue *internGitlab.Issue) (*internGitlab.Issue, error)
	GetYourAssignments(ctx context.Context, user *UserInfo) ([]*internGitlab.Issue, error)
	GetYourRepos(ctx context.Context, user *UserInfo) ([]*internGitlab.Project, error)
