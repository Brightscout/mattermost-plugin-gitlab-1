...
func (m *MockGitlab) AttachCommentToIssue(arg0 context.Context, arg1 *gitlab.UserInfo, arg2 *gitlab.IssueRequest) (*gitlab0.Note, error) {
	m.ctrl.T.Helper()
...
func (m *MockGitlab) GetAssignees(arg0 context.Context, arg1 *gitlab.UserInfo, arg2 string) ([]*gitlab0.ProjectMember, error) {
	m.ctrl.T.Helper()
